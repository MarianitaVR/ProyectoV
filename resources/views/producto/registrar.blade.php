                            ...
                            <div class="card-body pt-0">
                              <div class="d-flex flex-wrap gap-5">
                                <div class="fv-row w-100 flex-md-root">
                                  <label class="required form-label">ID PRODUCTO</label>
                                    <input type="text" name="idProducto" class="form-control mb-2" placeholder="ID de los productos" value="" />
                                </div>
                                  <div class="fv-row w-100 flex-md-root">
                              ...
                              <div class="card-body pt-0">
                                <div class="d-flex flex-wrap gap-5">
                                  ...
                                  <div class="fv-row w-100 flex-md-root">
                                        ...
                                        <label class="required form-label">ID CATEGORÍA</label>
                                        <select class="form-select mb-2" name="idCategoria" data-control="select2"
                                                    data-hide-search="true" data-placeholder="Categoría producto">
                                          <option></option>
                                          @foreach($productos as $producto)
                                          <option value="{{$producto->idCategoria}}">{{$producto->descripcioProducto}}</option>
                                    ...
                                    <div class="fv-row w-100 flex-md-root">
                                      <label class="required form-label">ESTADO</label>
                                        <select class="form-select mb-2" name="estadoProducto" data-control="select2"
